      ...
      <template #bodyCell="{ column, record }">
        <template v-if="column.key === 'active'">
          <a-space>
            ...
            &emsp;
            <a v-if="hasPermission('bems:areafullyopen')" @click.stop="handleOpen(record)">全开</a>
            &emsp;
            <a v-if="hasPermission('bems:areafullyclose')" style="color:  red;" @click.stop="handleClose(record)">全关</a>
          </a-space>
        </template>
      </template>
    </BasicTable>
