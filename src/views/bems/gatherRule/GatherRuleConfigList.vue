<template>
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      <!--插槽:table标题-->
      <template #tableTitle>
        <a-button type="primary" v-auth="'bems:gather_rule_config:add'" @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增</a-button>
    ...
    <!-- 表单区域 -->
    <GatherRuleConfigModal @register="registerModal" @success="handleSuccess" />
  </div>
</template>
