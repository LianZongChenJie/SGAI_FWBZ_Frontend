<template>
  <div>
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      <!--插槽:table标题-->
      <template #tableTitle>
        <a-button type="primary" v-auth="'bems:energy_price:add'" @click="handleAdd" preIcon="ant-design:plus-outlined"> 新增</a-button>
        ...
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'bems:energy_price:deleteBatch'"
            >批量操作
...
<script lang="ts" name="bems-energyPrice" setup>
  ...
  import { list, deleteOne, batchDelete, getImportUrl, getExportUrl } from './EnergyPrice.api';
