...
const pipes = halls.flatMap((hall, hallIndex) => {
  ...
  return [
    ...
    { kind: 'return', x: x + 42, y: 385, w: 92, h: 5, dir: 'left' },
    { kind: 'return', x: x + 42, y: 403, w: 310, h: 5, dir: 'right' },
    { kind: 'return', x: x + 42, y: 462, w: 310, h: 5, dir: 'right' },
    { kind: 'return', x: x + 42, y: 385, w: 90, h: 5, dir: 'left' },
    { kind: 'return', x: x + 347, y: 123, w: 5, h: 341, dir: 'up' },

    { kind: 'return', x: x + 42, y: 275, w: 90, h: 5, dir: 'left' },
    { kind: 'return', x: x + 43, y: 220, w: 23, h: 4, dir: 'right' },
    { kind: 'return', x: x + 113, y: 210, w: 18, h: 4, dir: 'right' },
    { kind: 'return', x: x + 128, y: 210, w: 4, h: 66, dir: 'down' },
    ...unitYs.map(y => ({ kind: 'return', x: x + 300, y, w: 52, h: 5, dir: 'left' })),
    // 冷冻供水（蓝）：三台机组左侧出口汇入供水立管，再向左、向上送至场馆末端。
    { kind: 'supply', x: x + 180, y: 119, w: 5, h: 176, dir: 'up' },
    ...unitYs.map(y => ({ kind: 'supply', x: x + 180, y, w: 48, h: 5, dir: 'left' })),
    { kind: 'supply', x: x + 84, y: 119, w: 101, h: 5, dir: 'left' },
    { kind: 'supply', x: x + 84, y: 101, w: 5, h: 22, dir: 'up' },
    // 水处理与脱气旁通均取自本馆回水主管并回到本馆回路。
    { kind: 'return', x: x + 43, y: 326, w: 20, h: 4, dir: 'right' },
    { kind: 'return', x: x + 113, y: 336, w: 20, h: 4, dir: 'right' },
    { kind: 'return', x: x + 130, y: 337, w: 4, h: 50, dir: 'down' },
