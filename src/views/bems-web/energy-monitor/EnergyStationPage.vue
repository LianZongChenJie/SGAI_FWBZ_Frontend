      ...
      <section class="content-grid">
        <article class="panel topology-panel">
          <div class="panel-heading">
            <h2>{{ activeSystem === 'water' ? '集中水冷系统实时监控' : activeSystem === 'air' ? '集中风冷系统实时监控' : '东会议室 / 2号馆 / 3号馆分馆风冷监控' }}</h2>
...
.subnav :deep(.ant-tabs-tab) { padding:10px 4px !important; font-size:16px; }
...
.overview-name { display:flex; flex-direction:column; align-items:center; justify-content:center; gap:8px; border:1px solid var(--edge); border-radius:10px; background:linear-gradient(135deg,rgba(15,38,55,.92),rgba(8,25,38,.78)); color:#dcebf5; font-size:16px; font-weight:600; letter-spacing:1px; writing-mode:vertical-rl; }
