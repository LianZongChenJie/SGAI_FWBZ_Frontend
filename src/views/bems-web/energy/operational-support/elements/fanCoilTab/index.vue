...
import { getSpaceTree, getDeviceAttrList, selectDevice, getFanCoilStatistics, exportData, findDeviceControlPoint, realTimeData } from './index.api'
...
const handleExport = async () => {
  ...
  try {
    ...
    link.href = url
    link.setAttribute('download', '风机盘管列表' + fileSuffix)
