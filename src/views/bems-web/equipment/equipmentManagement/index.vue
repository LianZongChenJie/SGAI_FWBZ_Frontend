<template>
  <div class="equip-page">
    <div class="stat-cards">
      <StatCard label="设备总数" :value="statData.count" change-text="" trend="" color="blue" :icon="DeviceTotalIcon" />
      <StatCard label="在线数量" :value="statData.online" change-text="" trend="" color="green" :icon="OnlineIcon" />
      <StatCard label="仪表数量" :value="statData.measuringCount" change-text="" trend="" color="orange" :icon="MeterIcon" />
      <StatCard label="运行数量" :value="statData.equipmentCount" change-text="" trend="" color="purple" :icon="RunningCountIcon" />
    </div>
    <div class="equip-management">
      <DeviceCategory :tree-data="categoryTreeData" :space-tree-data="spaceTreeData" :get-tree-data="getTreeData" />
    </div>
  </div>
</template>
