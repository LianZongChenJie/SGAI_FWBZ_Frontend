<template>
  <div class="venue-scheduling">
    ...
    <!-- 场馆详情弹窗 -->
    <a-modal v-model:visible="detailVisible" :title="`${currentVenueName} - 展商信息`" :footer="null" width="800px" destroy-on-close>
      <a-table :columns="detailColumns" :data-source="detailList" :loading="detailLoading" :pagination="false" row-key="id" size="middle">
        <template #emptyText>
...
<script setup lang="ts">
  ...
  import { ThunderboltOutlined, ShopOutlined, CloudOutlined, SettingOutlined, CaretDownOutlined, CaretUpOutlined } from '@ant-design/icons-vue';
