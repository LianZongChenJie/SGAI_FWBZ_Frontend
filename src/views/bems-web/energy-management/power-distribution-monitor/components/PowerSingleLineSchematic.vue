<template>
  <div ref="viewportRef" class="power-viewport">
    <div class="scroll-guide">
      <span><i></i>一次系统大画布</span>
      <b>横向、纵向滚动查看全部 {{ feeders.length }} 条出线</b>
      <button @click="resetView">回到总览起点</button>
    </div>

    <div class="power-canvas" :style="{ width: `${canvasWidth}px` }">
...
function resetView() { viewportRef.value?.scrollTo({ left: 0, top: 0, behavior: 'smooth' }) }
