<template>
  <div class="energy-page">
    ...
    <!-- <header class="topbar">
      ...
      <div class="station-title"><i></i><span>首钢园 · 2/3/4号场馆</span><em>集中水冷系统</em></div>
    ...
    <main class="dashboard-body">
      <section class="content-grid">
        <article class="panel topology-panel">
          ...
          <div class="topology">
            <EnergyPlantSchematic :values="values" @select-chiller="selectedChiller = $event" @select-device="openDevice" />
