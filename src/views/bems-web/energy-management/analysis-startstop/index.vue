...
function renderCharts() {
  ...
  loadChart.setOption({ animationDuration: 500, grid: { left: 48, right: 22, top: 28, bottom: 34 }, tooltip: { trigger: 'axis', backgroundColor: '#ffffff', borderColor: '#e2e8f0', textStyle: { color: '#2d3748', fontSize:13 } }, xAxis: { type: 'category', data: chartHours, boundaryGap: false, axisLine: { lineStyle: { color: '#e2e8f0' } }, axisLabel: { color: '#94a3b8', fontSize: 9, interval: 1 } }, yAxis: { type: 'value', name: 'kW', nameTextStyle: { color: '#94a3b8' }, axisLabel: { color: '#94a3b8', fontSize: 9 }, splitLine: { lineStyle: { color: 'rgba(148,163,184,.25)' } } }, series: [
