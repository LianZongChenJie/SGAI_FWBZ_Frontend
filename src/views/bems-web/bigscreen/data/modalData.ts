    ...
    rightPanel: {
      ...
      data: {
        ...
        columns: [
          ...
          { title: '用电kWh', key: 'electricity', width: 100 },
          { title: '用电量占比', key: 'electricityProportion', width: 70 },
          { title: '用电量环比', key: 'electricityMoM', width: 70 },
        ],
        rows: [
          { name: 'A馆', electricity: '15,680', electricityProportion: '320', electricityMoM: { text: '↓5.2%', color: '#4ade80' } },
          { name: 'B馆', electricity: '12,450', electricityProportion: '245', electricityMoM: { text: '↓3.8%', color: '#4ade80' } },
          { name: 'C馆', electricity: '8,920', electricityProportion: '186', electricityMoM: { text: '↑1.2%', color: '#f87171' } },
          { name: '会议中心', electricity: '3,200', electricityProportion: '78', electricityMoM: { text: '↓8.5%', color: '#4ade80' } },
          { name: '公共区域', electricity: '1,906', electricityProportion: '27', electricityMoM: { text: '↓2.1%', color: '#4ade80' } },
        ],
      },
    },
    trend: {
  ...
  security: {
    ...
    rightPanel: {
      ...
      data: {
        title: '🧯 控制器列表',
        columns: [
          { title: '设备名称', key: 'name', width: 130 },
          { title: '设备IP', key: 'ip', width: 100 },
          { title: '区域名称', key: 'regionName', width: 130 },
          { title: '在线状态', key: 'abnormal', width: 100 },
        ],
        rows: [
          { name: 'A馆东门控制器', ip: '192.168.1.21', regionName: 'A馆', abnormal: { text: '在线', color: '#4ade80' } },
          { name: 'A馆南门控制器', ip: '192.168.1.22', regionName: 'A馆', abnormal: { text: '在线', color: '#4ade80' } },
          { name: 'B馆门禁控制器', ip: '192.168.1.31', regionName: 'B馆', abnormal: { text: '在线', color: '#4ade80' } },
          { name: 'C馆门禁控制器', ip: '192.168.1.41', regionName: 'C馆', abnormal: { text: '离线', color: '#f87171' } },
          { name: '会议中心门禁控制器', ip: '192.168.1.51', regionName: '会议中心', abnormal: { text: '在线', color: '#4ade80' } },
        ],
      },
    },
    extraTable: {
      title: '📋 门禁地点列表',
      columns: [
        { title: '门禁地点名称', key: 'name', width: 230 },
        { title: '门禁地点编号', key: 'doorNo', width: 100 },
        { title: '区域名称', key: 'regionName', width: 200 },
        { title: '门状态', key: 'doorState', width: 100 },
      ],
      rows: [
        { name: 'A馆东门门禁', doorNo: 'A-F1-01', regionName: 'A馆', doorState: { text: '开门状态', color: '#4ade80' } },
        { name: 'A馆南门门禁', doorNo: 'A-F1-02', regionName: 'A馆', doorState: { text: '关门状态', color: '#38bdf8' } },
        { name: 'B馆正门门禁', doorNo: 'B-F1-01', regionName: 'B馆', doorState: { text: '开门状态', color: '#4ade80' } },
        { name: 'C馆门禁', doorNo: 'C-F1-01', regionName: 'C馆', doorState: { text: '离线状态', color: '#f87171' } },
        { name: '会议中心门禁', doorNo: 'M-F1-01', regionName: '会议中心', doorState: { text: '关门状态', color: '#38bdf8' } },
      ],
    },
  },
  ...
  kpiPower: {
    ...
    leftPanel: {
      ...
      data: {
        title: '📊 各时段用电分布',
        columns: [
          { title: '时段', key: 'timePeriod' },
          { title: '用电量kWh', key: 'electricity', width: 110 },
          { title: '占比', key: 'proportion', width: 70 },
          { title: '环比', key: 'moM', width: 70 },
        ],
        rows: [
          { timePeriod: '00:00-06:00', electricity: '2,450', proportion: '5.8%', moM: { text: '↓12%', color: '#4ade80' } },
          { timePeriod: '06:00-09:00', electricity: '5,680', proportion: '13.5%', moM: { text: '↑8%', color: '#f87171' } },
          { timePeriod: '09:00-12:00', electricity: '12,340', proportion: '29.3%', moM: { text: '↑5%', color: '#f87171' } },
          { timePeriod: '12:00-14:00', electricity: '8,920', proportion: '21.2%', moM: { text: '↓3%', color: '#4ade80' } },
          { timePeriod: '14:00-18:00', electricity: '9,560', proportion: '22.7%', moM: { text: '↓2%', color: '#4ade80' } },
          { timePeriod: '18:00-24:00', electricity: '3,206', proportion: '7.5%', moM: { text: '↓15%', color: '#4ade80' } },  
        ],
      },
    },
    rightPanel: {
      ...
      data: {
        ...
        rows: [
          { name: 'A馆', electricity: '15,680', electricityProportion: '37.2%', electricityMoM: { text: '↓5.2%', color: '#4ade80' } },
          { name: 'B馆', electricity: '12,450', electricityProportion: '29.5%', electricityMoM: { text: '↓3.8%', color: '#4ade80' } },
          { name: 'C馆', electricity: '8,920', electricityProportion: '21.2%', electricityMoM: { text: '↑1.2%', color: '#f87171' } },
          { name: '会议中心', electricity: '3,200', electricityProportion: '7.6%', electricityMoM: { text: '↓8.5%', color: '#4ade80' } },
          { name: '公共区域', electricity: '1,906', electricityProportion: '4.5%', electricityMoM: { text: '↓2.1%', color: '#4ade80' } },
        ],
      },
    },
    trend: {
